...
cat = [9 for i in range(49)]
np.save("image_compression_categories.npy",cat)
np.save('image_compression_4v8g_x.npy',data_x[0:num])
np.save('image_compression_4v8g_y.npy',data_y[0:num])